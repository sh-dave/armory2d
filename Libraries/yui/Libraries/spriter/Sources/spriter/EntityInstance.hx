...
class EntityInstance{
	...
	public function playId( id: Int ) {
		var animation = animations[animationNames[id]];
		_play(animation);
	}
	...
	var animationNames: Array<String>; // TODO (DK) refactor together with animation map
	...
	private function new(entity : Entity, metadataEnabled : Bool){
		...
		animationNames = [for (anim in entity.animations) anim.name];
